...
class HulpverlenerDetailPageTest extends AdminAcceptanceTest
{
    ...
    {
        $location = Factory::attributesFor('location', ['name' => 'knownLocationName']);
    ...
    public function test_creating_organisation()
    {
        ...
        $location = array_only(Factory::attributesFor('location', ['name' => 'knownLocationName']), ['name', 'street', 'postal', 'city']);
