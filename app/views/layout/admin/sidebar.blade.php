<section id="sidebar" class="col-md-3 col-xs-12">
    ...
    <ul>
    	...
    	<li>
    	    <a href="{{ route('questionnaires.index') }}"><span class="glyphicons notes_2"></span>{{ Lang::get('master.navs.questionnaires') }}</a>
    	</li>
    	@endif

    	<li>
    	    <a href="{{ action('InstrumentController@index') }}"><span class="glyphicon glyphicon-list-alt"></span>{{ Lang::get('master.navs.instrument') }}</a>
    	</li>
    	<li>
    	    <a href="{{ action('RapportController@getIndex') }}"><span class="glyphicon glyphicon-folder-close"></span>{{ Lang::get('master.navs.rapport') }}</a>
    	</li>
    	<li>
